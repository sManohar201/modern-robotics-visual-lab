...
export const chapters: ChapterDef[] = [
  {
    ...
    pages: [
      ...
      {
        id: "math2-linalg",
        title: "Math: Matrices — Machines for Arrows",
        status: "ready",
        challenges: ["math2-rotate", "math2-collapse", "math2-quiz"],
        component: lazy(() => import("./physics/MathLinearAlgebra")),
      },
      {
        id: "math3-calculus",
        title: "Math: Rates and Accumulation",
        status: "ready",
        challenges: ["math3-flat", "math3-accumulate", "math3-partial", "math3-quiz"],
        component: lazy(() => import("./physics/MathCalculus")),
      },
      {
        id: "math4-diffeq",
        title: "Math: Equations of Change",
        status: "ready",
        challenges: ["math4-decay", "math4-orbit", "math4-quiz"],
        component: lazy(() => import("./physics/MathDiffEq")),
      },
      {
        id: "phys1-foundations",
        title: "Vectors, Motion, and Projectiles",
        status: "ready",
        challenges: ["phys1-vector-3-4-5", "phys1-motion-stop", "phys1-projectile-target", "phys1-relative-cross", "phys1-quiz"],
      ...
      },
      {
        ...
        status: "ready",
        challenges: ["phys2-fbd-accel3", "phys2-incline-slip", "phys2-pulley-accel2", "phys2-quiz"],
      ...
      },
      {
        ...
        status: "ready",
        challenges: ["phys3-coaster-top", "phys3-spring-pe20", "phys3-work-50j", "phys3-quiz"],
      ...
      },
      {
        ...
        status: "ready",
        challenges: ["phys4-elastic-stop", "phys4-cm-target", "phys4-quiz"],
      ...
      },
      {
        ...
        status: "ready",
        challenges: ["phys5-torque-2nm", "phys5-inertia-target", "phys5-rolling-sphere-wins", "phys5-quiz"],
      ...
      },
      {
        ...
        status: "ready",
        challenges: ["phys6-critical-damp", "phys6-pendulum-chaos", "phys6-resonance-peak", "phys6-quiz"],
      ...
      },
      {
        ...
        status: "ready",
        challenges: ["phys7-field-icr", "phys7-icr-verify", "phys7-fourbar-trace", "phys7-quiz"],
      ...
      },
      {
        ...
        status: "ready",
        challenges: ["phys8-small-angle", "phys8-double-chaos", "phys8-quiz"],
      ...
      },
      {
        ...
        status: "ready",
        challenges: ["phys9-pressure-50kpa", "phys9-buoy-float", "phys9-venturi-fast", "phys9-quiz"],
      ...
      },
      {
        ...
        status: "ready",
        challenges: ["phys10-gravity-comp", "phys10-coriolis-deflect", "phys10-quiz"],
    ...
    pages: [
      {
        ...
        status: "ready",
        challenges: ["ch5-jac-tour", "ch5-jac-columns", "ch5-jacobian-quiz"],
      ...
      },
      {
        ...
        status: "ready",
        challenges: ["ch5-statics-load", "ch5-statics-door", "ch5-statics-quiz"],
      ...
      },
      {
        ...
        title: "Singularities",
        status: "ready",
        challenges: ["ch5-sing-reach", "ch5-sing-cases", "ch5-sing-quiz"],
      ...
      },
      {
        ...
        status: "ready",
        challenges: ["ch5-manip-flat", "ch5-manip-isotropy", "ch5-manip-quiz"],
    ...
    pages: [
      {
        ...
        status: "ready",
        challenges: ["ch7-rpr-inverse", "ch7-closed-quiz"],
      ...
      },
      {
        ...
        status: "ready",
        challenges: ["ch7-fk-vanish", "ch7-rpr-fk-modes", "ch7-fk-quiz"],
      ...
      },
      {
        ...
        status: "ready",
        challenges: ["ch7-sg-tilt", "ch7-sg-quiz"],
      ...
      },
      {
        ...
        status: "ready",
        challenges: ["ch7-fourbar-bifurcation", "ch7-fivebar-singularity", "ch7-sing-quiz"],
  ...
  },
  {
    ...
    pages: [
      ...
      },
      {
        ...
        status: "ready",
        challenges: ["ch8-mass-circle", "ch8-mass-matrix-max", "ch8-massmatrix-quiz"],
      ...
      },
      {
        ...
        status: "ready",
        challenges: ["ch8-rnea-torque", "ch8-rnea-quiz"],
  ...
  },
  {
    ...
    pages: [
      ...
      },
      {
        ...
        status: "ready",
        challenges: ["ch9-car-switch", "ch9-time-optimal-scaling", "ch9-timeopt-quiz"],
    ...
    pages: [
      {
        ...
        status: "ready",
        challenges: ["ch11-pid-overshoot", "ch11-pid-quiz"],
      ...
      },
      {
        ...
        status: "ready",
        challenges: ["ch11-computed-torque", "ch11-ct-quiz"],
      ...
      },
      {
        ...
        status: "ready",
        challenges: ["ch11-impedance-soft", "ch11-imp-quiz"],
  ...
  },
  {
    ...
    pages: [
      ...
      },
      {
        ...
        status: "ready",
        challenges: ["ch12-span-full", "ch12-grasp-closure", "ch12-closure-quiz"],
    ...
    pages: [
      {
        ...
        status: "ready",
        challenges: ["ch13-parallel-park", "ch13-nonholo-quiz"],
      ...
      },
      {
        ...
        status: "ready",
        challenges: ["ch13-omni-tracking", "ch13-drive-quiz"],
